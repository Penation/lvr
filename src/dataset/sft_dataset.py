...
from .data_utils import get_image_info, get_video_info, llava_to_openai, pad_sequence, resolve_media_path
...
class SupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        for data_src in meta_data:
            data_buffer = data_src['data_path']
            data_buffer = json.load(open(data_buffer, "r"))
